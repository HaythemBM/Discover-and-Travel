...
move = function (timeDelta) {
    ...
    stopp =0; 
     ...
     if(( (player.x<19.51 && player.y<13.7) || (player.x>19.6 && player.y<13.5)&& clicked2 === false) ){
      ...
      if(player.x>21.8 && player.x<22.2 && player.y>12.59 && clicked3 === false ){
       ...
       if(player.x<25.7 &&  player.y<9.66){
