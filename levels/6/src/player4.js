...
move = function (timeDelta) {
   ...
   if(player.x<9.4 && player.y<13.35 && clicked3 === false ){
        document.getElementById("popup3").style.display = "block";
        console.log('popup3');
        stopp=1; 
  
       }
       if(player.x<6.4 && player.y<12.35 && clicked4 === false ){
        document.getElementById("popup4").style.display = "block";
        console.log('popup4');
         stopp=1; 
    } 
    if(player.x>4.4 && player.x<6.3 &&  player.y<11.5 && player.y>11.2 && clicked5 === false ){
        document.getElementById("popup5").style.display = "block";
        console.log('popup5');
         stopp=1; 
    } 
    if(player.x>5.2 && player.x<7 &&  player.y<6.6 && player.y>6.4 && clicked6 === false ){
        document.getElementById("popup6").style.display = "block";
        console.log('popup6');
         stopp=1; 
    } 
    if(player.x>7.5 && player.x<7.6 &&  player.y<5.18 && player.y>3.7 && clicked7 === false ){
